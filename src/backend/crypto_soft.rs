...
fn inv_mix_columns(block: &mut [u8; 16]) {
    for col in 0..4 {
        ...
        // 13*x = 8*x ^ 4*x ^ x
        // 14*x = 8*x ^ 4*x ^ 2*x
        block[i] = (x8_0 ^ x4_0 ^ x2_0) ^ (x8_1 ^ x2_1 ^ b1) ^ (x8_2 ^ x4_2 ^ b2) ^ (x8_3 ^ b3);
        block[i + 1] =
            (x8_0 ^ b0) ^ (x8_1 ^ x4_1 ^ x2_1) ^ (x8_2 ^ x2_2 ^ b2) ^ (x8_3 ^ x4_3 ^ b3);
        block[i + 2] =
            (x8_0 ^ x4_0 ^ b0) ^ (x8_1 ^ b1) ^ (x8_2 ^ x4_2 ^ x2_2) ^ (x8_3 ^ x2_3 ^ b3);
        block[i + 3] =
            (x8_0 ^ x2_0 ^ b0) ^ (x8_1 ^ x4_1 ^ b1) ^ (x8_2 ^ b2) ^ (x8_3 ^ x4_3 ^ x2_3);
    }
}
