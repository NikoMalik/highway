...
mod x86_tests {
    ...
    fn extract_u64s<S: SimdCore + SimdCrypto>(
        s: S,
        v: S::Vec<u64>,
    ) -> Vec<u64> {
    ...
    fn test_aes_round_backends_match() {
        ...
        let key: [u8; 16] = [
            0xa0, 0xfa, 0xfe, 0x17, 0x88, 0x54, 0x2c, 0xb1, 0x23, 0xa3, 0x39,
            0x39, 0x2a, 0x6c, 0x76, 0x05,
        ];
    ...
    fn test_aes_last_round_backends_match() {
        ...
        let input: [u8; 16] = [
            0xeb, 0x40, 0xf2, 0x1e, 0x59, 0x2e, 0x38, 0x84, 0x8b, 0xa1, 0x13,
            0xe7, 0x1b, 0xc3, 0x42, 0xd2,
        ];
        let key: [u8; 16] = [
            0xd0, 0x14, 0xf9, 0xa8, 0xc9, 0xee, 0x25, 0x89, 0xe1, 0x3f, 0x0c,
            0xc8, 0xb6, 0x63, 0x0c, 0xa6,
        ];
    ...
    fn test_aes_round_inv_backends_match() {
        ...
        let input: [u8; 16] = [
            0x7a, 0x9f, 0x10, 0x27, 0x89, 0xd5, 0xf5, 0x0b, 0x2b, 0xef, 0xfd,
            0x9f, 0x3d, 0xca, 0x4e, 0xa7,
        ];
    ...
    fn test_aes_last_round_inv_backends_match() {
        ...
        let input: [u8; 16] = [
            0x63, 0x53, 0xe0, 0x8c, 0x09, 0x60, 0xe1, 0x04, 0xcd, 0x70, 0xb7,
            0x51, 0xba, 0xca, 0xd0, 0xe7,
        ];
    ...
    fn test_aes_round_multiblock_avx512() {
        ...
        let key: [u8; 16] = [
            0xca, 0xfe, 0xba, 0xbe, 0xde, 0xad, 0xf0, 0x0d, 0x01, 0x02, 0x03,
